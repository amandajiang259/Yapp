    ...
    try {
      ...
      if (selectedFile) {
        try {
          ...
          photoURL = `/api/files/${data.filename}`;
        } catch (uploadError) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              <span className="text-white text-sm">Welcome, {profileData.firstName}</span>
              <button
      ...
      <div className="py-12">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h1 className="text-2xl font-bold text-[#6c5ce7] mb-6 text-center">Edit Profile</h1>
